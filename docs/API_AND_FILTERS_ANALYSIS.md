...
#### **Primary Endpoint**
- **URL**: `https://marketplace-testingbackend.dhamarketplace.com/api/plots`
- **Method**: GET
- **Purpose**: Fetch all plots data
- **Response**: Array of PlotModel objects

#### **Filter Endpoints**
- **Price Range**: `https://marketplace-testingbackend.dhamarketplace.com/api/filter-plots-range`
- **Phase Filter**: `https://marketplace-testingbackend.dhamarketplace.com/api/plots?phase={phase}`
- **Category Filter**: `https://marketplace-testingbackend.dhamarketplace.com/api/plots?category={category}`
- **Status Filter**: `https://marketplace-testingbackend.dhamarketplace.com/api/plots?status={status}`
