...
import SplitRegisterForm from "@/components/auth/split-register-form"
import DashboardHeader from "@/components/dashboard/dashboard-header"
import Image from "next/image"
import Link from "next/link"

const REGISTER_ENABLED = true; // Toggle this to true to re-enable registration
...
export default function RegisterPage() {
  return (
    <>
      ...
      <div className="lg:hidden min-h-[calc(100vh-64px)] bg-gradient-to-br from-blue-50 via-white to-teal-50">
        <main className="flex flex-col items-center justify-center px-4 py-6">
          <div className="w-full max-w-md mb-4">
            <Image
              src="/images/800 x 400.png"
              alt="DHA Register Banner"
              width={800}
              height={400}
          ...
          <div className="w-full max-w-md">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <SplitRegisterForm disabled={!REGISTER_ENABLED} />
              </div>
